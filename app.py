...
d_copy['day_of_week'] = d_copy['day_of_week'].astype(CategoricalDtype(categories=day, ordered=False))

month = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September',
         'October', 'November', 'December']

d_copy["month"] = d_copy["month"].astype(CategoricalDtype(categories=month, ordered=True))
